...
```sh
sh tools/downloads_to_icloud/install.sh
```
...
```sh
sh tools/downloads_to_icloud/uninstall.sh
```
...
```sh
python3 tools/downloads_to_icloud/downloads_to_icloud.py --once
```

## Test

```sh
python3 tests/tools_downloads_to_icloud/test_downloads_to_icloud.py -v
```
